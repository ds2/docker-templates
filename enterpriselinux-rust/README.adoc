...
podman run -it --rm -e SEMVER_PARAMS="-a -g -m 8" -e MIRROR_SRC_DIR=y -e CARGO_HOME=/tmp/cargo -v /tmp/cargo:/tmp/cargo -v $(pwd):/work quay.io/ds2/elx-rust:${DISTRO_VERSION}
